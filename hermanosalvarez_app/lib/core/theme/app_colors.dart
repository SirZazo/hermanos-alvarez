...
class AppColors {
  ...
  static const Color navInnerBackground = Color.fromRGBO(255, 255, 255, 0.1);
  ...
  static const Color buttonSecondaryBorder = Color.fromRGBO(255, 255, 255, 0.28);
  static const Color buttonSecondaryBackground = Color.fromRGBO(255, 255, 255, 0.08);
